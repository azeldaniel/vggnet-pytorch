...
class VGGNet19(torch.nn.Module):
    """
    ...
    def __init__(self, num_classes=1000):
        ...
        b3 = torch.nn.Sequential(
            ...
            # Layer 10 - Convolution Layer - Nx256x56x56 -> Nx256x56x56
            torch.nn.Conv2d(in_channels=256, out_channels=256,
                            kernel_size=3, padding=1),
            torch.nn.ReLU(inplace=True),
        ...
        b4 = torch.nn.Sequential(
            ...
            # Layer 15 - Convolution Layer - Nx512x28x28 -> Nx512x28x28
            torch.nn.Conv2d(in_channels=512, out_channels=512,
                            kernel_size=3, padding=1),
            torch.nn.ReLU(inplace=True),
        ...
        b5 = torch.nn.Sequential(
            ...
            # Layer 20 - Convolution Layer - Nx512x14x14 -> Nx512x14x14
            torch.nn.Conv2d(in_channels=512, out_channels=512,
                            kernel_size=3, padding=1),
            torch.nn.ReLU(inplace=True),
